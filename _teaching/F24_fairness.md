...
**Prerequisites**: CS1, comfort with probability (Randomness and Computation) required.
...
- **Homework 1 due**: Sept 4 (overview of probability, prereqs)

- **Homework 2 due**: Sept 20 (group fairness via parity)

- **Homework 3 due**: October 4 (calibration and individual fairness)

- **Homework 4 due**: November 1 (utilitarianism, welfare, and social choice)

- **Homework 5 due**: November 15 (fairness in resource allocation and fair division)
...
**Dec 12ish**: During final exam period, project presentations. At the beginning of the exam period, technical reports due as well.
